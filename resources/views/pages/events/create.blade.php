                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.event.store') }}">
                            ...
                            <div class="form-group">
                                ...
                                @endphp
                                <p class="text-muted pt-1"><span>{{$rootUrl}}</span><span id="slugPreview" class="text-black"></span></p>
                                <input type="hidden" id="eventSlug" name="slug" placeholder="slug" value="{{ old('slug') }}"
                            ...
                            <div class="map-container mb-3" style="background: linear-gradient(120deg, #00e4d0, #5983e8); margin: 0 -1.81rem;">
                                ...
                                <div class="d:f j-c:s-b a-i:c flx-d:c-r p:.5 bg-light text-black">
                                    ...
                                    <span id="latlngspan">{{ "(" . old('latitude') . ", " . old('latitude') . ")" }}</span>
                                </div>
                            </div>

                            <div class="form-group d-none">
                                <label for="eventLat">Latitude<i class="text-danger">*</i></label>
                                <input type="text" id="eventLat" name="latitude" value="{{ old('latitude') }}"
                            ...
                            <div class="form-group d-none">
                                ...
                                <input type="text" id="eventLong" name="longitude" value="{{ old('longitude') }}"
                            ...
                            <div class="form-group" style="display: none">
                                ...
                                <input type="text" id="eventDate" name="date" placeholder="Pick a date" value="{{ old('date') }}"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" id="description" placeholder="description" rows="2" class="form-control @if($errors->has('description')) is-invalid @endif">{{ old('description') }}</textarea>
